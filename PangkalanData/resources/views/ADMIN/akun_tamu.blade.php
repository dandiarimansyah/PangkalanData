  ...
  @endif
    ...
    <div class="judul">
        ...
        {{-- <div class="import-input">
            <h6>Klik "TAMBAH AKUN" untuk menambahkan Tamu Baru</h6>
            ...
            @forelse ($operator as $key => $a)
                    <tr>
                        ...
                        <td style="display: flex; justify-content:center;">
                            ...
                            <a class="hapus" href="{{ url('/admin/akun_tamu/hapus/' . $a->id) }}" data-toggle="tooltip" id="pesan">Hapus</a>
                        </td>
                    </tr>
                @empty
                    <tr>
...
<div class="modal fade" id="add-modal">
    ...
    <div id="modal-content" class="modal-content">
        ...
        <h5 class="modal-title" id="exampleModalLabel">TAMBAH AKUN TAMU BARU</h5>
        ...
        <div class="modal-body">
            <div class="wrapper" style="margin: 0">
                <div class="form">
                    <form id="add_form" action="/admin/akun_tamu" method="POST">
                        @csrf
...
<div class="modal fade" id="edit_akun-modal">
    ...
    <div id="modal-content" class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">EDIT AKUN TAMU</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
        </div>
