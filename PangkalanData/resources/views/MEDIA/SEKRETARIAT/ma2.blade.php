                    ...
                    @auth
                        @if (Auth::user()->level != 'tamu')
                            ...
                            <div style="margin:5px auto">
                                <form method="POST" id="media_form" role="form" action="{{ url('/media/sekretariat/tanah_dan_bangunan/' . $a->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                            ...
                            @else
                                ...
                                <a id="hapus_media" href="{{ url('/media/sekretariat/tanah_dan_bangunan/hapus/' . $a->id) }}" style="margin-left:12px; color:white" class="btn btn-sm btn-danger">Hapus Dokumen</a>
                            @endif
                        @else
                            @if ($a->media == "")
                            <div style="margin:5px auto">
