...
@if (session('status'))
    <div id="flash" data-url="{{ URL('operator/edit/penelitian/penelitian')}}" data-flash="{{ session('status') }}"></div>
@endif
...
@if ($errors->any())
    ...
    <div class="judul">
      ...
      <button loc="{{ asset('/Template/Template Komunitas Sastra.xlsx')}}" href="{{url('/import/komunitas/komunitas_sastra')}}" id="import_data" type="button" class="btn btn-primary" style="border-radius: 5px"  data-toggle="modal" data-target="#import">
  ...
  <div class="wrapper">
      ...
      <form role="form" action="{{url('/operator/input/komunitas/komunitas_sastra')}}" method="POST">
          @csrf
