...
@if ($errors->any())
    ...
    <div class="judul">
      ...
      <button loc="{{ asset('/Template/Template Penghargaan Sastra.xlsx')}}" href="{{url('/import/kesastraan/penghargaan_sastra')}}" id="import_data" type="button" class="btn btn-primary" style="border-radius: 5px"  data-toggle="modal" data-target="#import">
  ...
  <div class="wrapper">
      ...
      <form role="form" action="{{url('/operator/input/kesastraan/penghargaan_sastra')}}" method="POST" enctype="multipart/form-data">
          @csrf
