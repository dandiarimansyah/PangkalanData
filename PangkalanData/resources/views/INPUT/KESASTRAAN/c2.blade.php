...
@if ($errors->any())
    ...
    <div class="judul">
      ...
      <button loc="{{ asset('/Template/Template Penghargaan Sastra.xlsx')}}" href="/import/kesastraan/penghargaan_sastra" id="import_data" type="button" class="btn btn-primary" style="border-radius: 5px"  data-toggle="modal" data-target="#import">
        IMPORT EXCEL
      </button>
    </div>
