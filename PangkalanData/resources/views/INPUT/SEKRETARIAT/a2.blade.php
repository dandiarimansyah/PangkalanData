...
@if ($errors->any())
  ...
  <div class="judul">
    ...
    <div class="import-input">
      ...
      <button loc="{{ asset('/Template/Template Realisasi Anggaran.xlsx')}}" href="{{ url('/import/sekretariat/realisasi_anggaran')}}" id="import_data" type="button" class="btn btn-primary" style="border-radius: 5px"  data-toggle="modal" data-target="#import">
  ...
  <div class="wrapper">
      <div class="form">
        <form role="form" action="{{ url('/operator/input/sekretariat/realisasi_anggaran')}}" method="POST">
          @csrf
