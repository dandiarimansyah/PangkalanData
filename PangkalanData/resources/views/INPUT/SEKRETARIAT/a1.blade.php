...
<div class="isi-konten">
  ...
  <div class="judul">
    ...
    <div class="import-input">
      ...
      <button loc="{{ asset('/Template/Template Anggaran.xlsx')}}" href="{{ url('/import/sekretariat/anggaran')}}" id="import_data" type="button" class="btn btn-primary" style="border-radius: 5px"  data-toggle="modal" data-target="#import">
  ...
  <div class="wrapper">
      <div class="form">
        <form role="form" action="{{ url('/operator/input/sekretariat/anggaran')}}" method="POST">
          @csrf
