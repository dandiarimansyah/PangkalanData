...
@if ($errors->any())
    ...
    <div class="judul">
      ...
      <button loc="{{ asset('/Template/Template Penelitian.xlsx')}}" href="{{url('/import/penelitian/penelitian')}}" id="import_data" type="button" class="btn btn-primary" style="border-radius: 5px"  data-toggle="modal" data-target="#import">
  ...
  <div class="wrapper">
      ...
      <form role="form" action="{{url('/operator/input/penelitian/penelitian')}}" method="POST" enctype="multipart/form-data">
          @csrf
<!-- 
