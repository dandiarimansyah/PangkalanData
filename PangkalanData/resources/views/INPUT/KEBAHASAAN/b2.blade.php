...
@if (session('status'))
    <div id="flash" data-url="{{ URL('operator/edit/kebahasaan/jurnal_majalah')}}" data-flash="{{ session('status') }}"></div>
@endif
...
@if ($errors->any())
  ...
  <div class="judul">
    ...
    <div class="import-input">
      ...
      <button loc="{{ asset('/Template/Template Jurnal Majalah.xlsx')}}" href="{{url('/import/kebahasaan/jurnal_majalah')}}" id="import_data" type="button" class="btn btn-primary" style="border-radius: 5px"  data-toggle="modal" data-target="#import">
  ...
  <div class="wrapper">
      ...
      <form role="form" action="{{url('/operator/input/kebahasaan/jurnal_majalah')}}" method="POST" enctype="multipart/form-data">
          @csrf
