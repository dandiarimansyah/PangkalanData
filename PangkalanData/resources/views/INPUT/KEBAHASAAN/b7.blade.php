...
@if ($errors->any())
  ...
  <div class="judul">
    ...
    <div class="import-input">
      ...
      <button loc="{{ asset('/Template/Template Duta Bahasa Nasional.xlsx')}}" href="{{url('/import/kebahasaan/duta_bahasa_nasional')}}" id="import_data" type="button" class="btn btn-primary" style="border-radius: 5px"  data-toggle="modal" data-target="#import">
  ...
  <div class="wrapper">
      ...
      <form role="form" action="{{url('/operator/input/kebahasaan/duta_bahasa_nasional')}}" method="POST" enctype="multipart/form-data">
          @csrf
