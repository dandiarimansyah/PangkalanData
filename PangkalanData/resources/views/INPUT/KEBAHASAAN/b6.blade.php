...
@if ($errors->any())
  ...
  <div class="judul">
    ...
    <div class="import-input">
      ...
      <button loc="{{ asset('/Template/Template Penghargaan Bahasa.xlsx')}}" href="/import/kebahasaan/penghargaan_bahasa" id="import_data" type="button" class="btn btn-primary" style="border-radius: 5px"  data-toggle="modal" data-target="#import">
