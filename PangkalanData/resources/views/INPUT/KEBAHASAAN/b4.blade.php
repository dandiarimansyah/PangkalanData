...
@if ($errors->any())
  ...
  <div class="judul">
    ...
    <div class="import-input">
      ...
      <button loc="{{ asset('/Template/Template Penyuluhan.xlsx')}}" href="{{url('/import/kebahasaan/penyuluhan')}}" id="import_data" type="button" class="btn btn-primary" style="border-radius: 5px"  data-toggle="modal" data-target="#import">
  ...
  <div class="wrapper">
      ...
      <form role="form" action="{{url('/operator/input/kebahasaan/penyuluhan')}}" method="POST" enctype="multipart/form-data">
          @csrf
