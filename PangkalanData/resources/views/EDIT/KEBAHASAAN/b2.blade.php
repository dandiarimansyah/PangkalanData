...
@if ($errors->any())
    ...
    <div class="input-baru">
        <a href="{{ URL("/operator/input/kebahasaan/jurnal_majalah")}}" type="button" class="btn btn-primary">
                  ...
                  <tr>
                      ...
                      <td style="display: flex; justify-content:center">
                        <button type="button" class="edit"
                          ...
                          <a class="hapus" href="{{ url('/operator/edit/kebahasaan/jurnal_majalah/hapus/' . $a->id) }}" data-toggle="tooltip"  id="pesan">Hapus</a>
                      </td>
                  </tr>
              @empty
                  <tr>
