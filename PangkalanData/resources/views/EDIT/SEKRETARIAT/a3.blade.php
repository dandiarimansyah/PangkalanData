...
@if ($errors->any())
    ...
    <div class="input-baru">
        <a href="{{ URL("/operator/input/sekretariat/kepegawaian")}}" type="button" class="btn btn-primary">
    ...
    <div class="validasi">
        <table class="content-table" id="datatable">
            <thead>
                <tr>
                    <th rowspan="2">NO</th>
                    <th style="max-width: 100px" rowspan="2">TANGGAL DIPERBARUI</th>
                ...
                @forelse ($kepegawaian as $key => $a)
                    <tr>
                        ...
                        <td style="display: flex; justify-content:center">
                            ...
                            <a class="hapus" href="{{ url('/operator/edit/sekretariat/kepegawaian/hapus/' . $a->id) }}" data-toggle="tooltip" id="pesan">Hapus</a>
                        </td>
                    </tr>
                @empty
                    <tr>
