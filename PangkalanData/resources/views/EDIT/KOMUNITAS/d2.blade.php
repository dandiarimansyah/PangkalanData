...
@if ($errors->any())
    ...
    <div class="input-baru">
        <a href="{{ URL("/operator/input/komunitas/komunitas_sastra")}}" type="button" class="btn btn-primary">
                ...
                @forelse ($komunitas_sastra as $key => $a)
                    <tr>
                        ...
                        <td style="display: flex; justify-content:center">
                            ...
                            >Edit</button>
                            <a class="hapus" href="{{ url('/operator/edit/komunitas/komunitas_sastra/hapus/' . $a->id) }}" data-toggle="tooltip" id="pesan">Hapus</a>
                        </td>
                    </tr>
                @empty
                    <tr>
        ...
        <div id="modal-edit" class="modal-dialog" role="document">
          <div id="modal-content" class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">EDIT DATA KOMUNITAS SASTRA</h5>
