...
@if ($errors->any())
    ...
    <div class="judul" style="display:flex; justify-content:center">
        <a href="{{ url("/pdf/kesastraan/bengkel_sastra_dan_bahasa?nama_kegiatan={$nama_kegiatan}&kota={$kota}&provinsi={$provinsi}")}}" target="_blank" type="button" class="btn btn-danger" style="border-radius: 5px;margin-right:15px;">
            EXPORT KE PDF
        </a>
        <a href="{{ url("/excel/kesastraan/bengkel_sastra_dan_bahasa?nama_kegiatan={$nama_kegiatan}&kota={$kota}&provinsi={$provinsi}")}}" target="_blank" type="button" class="btn btn-success" style="border-radius: 5px;margin-right:15px;">
            EXPORT KE EXCEL
        </a>
