...
@if ($errors->any())
    ...
    <div class="judul" style="display:flex; justify-content:center">
        <a href="{{ url("/pdf/kebahasaan/duta_bahasa_nasional?tahun={$tahun}&pemenang={$pemenang}")}}" target="_blank" type="button" class="btn btn-danger" style="border-radius: 5px;margin-right:15px;">
            <i style="margin-right: 4px" class="fa fa-file-pdf-o" aria-hidden="true"></i>
            EXPORT KE PDF
        </a>
        <a href="{{ url("/excel/kebahasaan/duta_bahasa_nasional?tahun={$tahun}&pemenang={$pemenang}")}}" target="_blank" type="button" class="btn btn-success" style="border-radius: 5px;margin-right:15px;">
