...
@include('PARTIAL.MenuLaporan')
    ...
    <div class="judul" style="display:flex; justify-content:center">
        ...
        <a href="{{ url('/pdf/sekretariat/realisasi_anggaran')}}" target="_blank" type="button" class="btn btn-info" style="border-radius: 5px;margin-right:15px;">
            EXPORT KE PDF
        </a>
        <a href="{{ url('/excel/sekretariat/realisasi_anggaran')}}" target="_blank" type="button" class="btn btn-success" style="border-radius: 5px;margin-right:15px;">
            EXPORT KE EXCEL
        </a>
