...
class Penghargaan_BahasaExport implements FromCollection, WithMapping, WithHeadings, ShouldAutoSize, WithEvents
{
    private $kategori;
    private $tahun;
    private $deskripsi;
    ...
    public function collection()
    {
        if ($this->kategori == '' and $this->tahun == '' and $this->deskripsi == '') {
            ...
            $data = Penghargaan_Bahasa::where('kategori', $this->kategori)
                ->get();
        } elseif ($this->kategori == '' and $this->tahun != '' and $this->deskripsi == '') {
            $data = Penghargaan_Bahasa::where('tahun', $this->tahun)
                ->get();
        } elseif ($this->kategori == '' and $this->tahun == '' and $this->deskripsi != '') {
            $data = Penghargaan_Bahasa::where('deskripsi', $this->deskripsi)
                ->get();
        } elseif ($this->kategori != '' and $this->tahun != '' and $this->deskripsi == '') {
            $data = Penghargaan_Bahasa::where('kategori', $this->kategori)
